					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<a href="${pageContext.request.contextPath }/inbox.html?a=view">
							...
							<li class="external">
								...
								<a href="${pageContext.request.contextPath }/inbox.html">See all messages <i class="m-icon-swapright"></i></a>
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${pageContext.request.contextPath }/media/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${pageContext.request.contextPath }/media/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="${pageContext.request.contextPath }/media/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${pageContext.request.contextPath }/media/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${pageContext.request.contextPath }/media/image/avatar3.jpg" />
