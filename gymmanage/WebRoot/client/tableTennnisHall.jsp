				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							乒乓球馆<!-- <small>news view samples</small> --> 
							...
							<div class="span8 blog-tag-data">
								...
								<div id="myCarousel" class="carousel slide">
									...
									<div class="carousel-inner">
										...
										<div class="item active">
											...
											<img src="${pageContext.request.contextPath }/media/image/tabletennis1.png" alt="">
										...
										<div class="item">
											...
											<img src="${pageContext.request.contextPath }/media/image/tabletennis2.png" alt="">
										...
										<div class="item">
											...
											<img src="${pageContext.request.contextPath }/media/image/tabletennis3.png" alt="">
								...
								<div class="news-item-page">
									...
									<blockquote class="hero">
										...
										<h3>乒乓球馆简介</h3>
										 <big>乒乓球场双打球场的标准尺寸长度是13.4米，宽度是6.10米，单打宽5.18米，理想的羽毛球比赛场地是用弹性的木材拼接而成（只要不是把小木块竖着拼接即可）。目前国际比赛已采用化学合成材料作为可移动的球场。当然，在基层的各级比赛中，当达不到上述条件的要求时，也可以在水泥地或三合土的地面上进行竞赛。现在的大学，机关，医院等一般都有自己的羽毛球场地，而且都是万奥塑胶的。不论是采用木板地面还是合成材料地面，都必须保证运动员在比赛中不感到太滑或太粘，并有一定的弹性。
										 </big>
