				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							场馆风采<!-- <small>windows 8 style tiles examples</small>-->
				...
				<!--  <div class="tiles">
					 ...
					 <div class="tile double-down bg-blue">
						...
						<div class="tile-body">
							 ...
							 <i class="icon-bell"></i>
							<img src="${pageContext.request.contextPath}/media/image/view1.png" alt="">
					...
					<div class="tile bg-green">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view5.png" alt="">
					...
					<div class="tile selected bg-red">
						...
						<div class="tile-body">
							...
							<!--  <i class="icon-user"></i>-->
							<img src="${pageContext.request.contextPath}/media/image/view6.png" alt="">
					...
					<div class="tile double bg-purple">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view4.png" alt="">
					  ...
					  <div class="tile bg-yellow">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view7.png" alt="">
				 ...
				 <div class="tile bg-green">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view8.png" alt="">
					...
					<div class="tile double bg-grey">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view3.png" alt="" class="pull-right">
					...
					<div class="tile image selected">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view2.png" alt="">
					...
					<div class="tile double bg-grey">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/view9.png" alt="" class="pull-right">
					...
					<div class="tile bg-yellow">
						...
						<div class="tile-body">
							  ...
							  <!--  <i class="icon-shopping-cart"></i>-->
							<img src="${pageContext.request.contextPath}/media/image/view10.png" alt="">
					...
					<div class="tile image double selected">
						...
						<div class="tile-body">
							...
							<img src="${pageContext.request.contextPath}/media/image/billiards1.png" alt="">
