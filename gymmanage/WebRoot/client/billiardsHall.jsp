				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							台球厅<!-- <small>news view samples</small> --> 
								...
								<div id="myCarousel" class="carousel slide">
									...
									<div class="carousel-inner">
										...
										<div class="item">
											...
											<img src="${pageContext.request.contextPath }/media/image/billiards2.png" alt="">
										...
										<div class="item">
											...
											<img src="${pageContext.request.contextPath }/media/image/billiards3.png" alt="">
